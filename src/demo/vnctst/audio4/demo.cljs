...
(def button-assign
  {
   ...
   :bgm-rnr {:fn #(vnctst.audio4/bgm! "bgm/rnr.*")
                  ...
                  :desc (str "\"bgm/rnr.{ogg,mp3}\" をBGMとして再生する。"
                             ...
                             "完了してから再生が開始される。"
                             "この辺りは雑に操作しても適切に処理されるので、"
                             "この辺りの再生/停止ボタンを素早く押しまくっても"
                             "問題はない。"
                             "実運用時も雑に扱ってよい。"
                             )
                  }
   :stop-bgm {:fn #(vnctst.audio4/stop-bgm!)
              :cljs "(vnctst.audio4/stop-bgm!)"
              :js "vnstst.audio4.js.stopBgm()"
              :desc "BGMをフェード停止させる。"
              }
   ;:stop-bgm-0 {:fn #(vnctst.audio4/stop-bgm! 0)
   ...
   :set-config-se-chattering-sec-0
   ...
   :set-config-default-bgm-fade-sec-2
   ...
   :set-config-default-se-fade-sec-1
   ...
   :set-config-dont-stop-on-background?-true
   ...
   :set-config-disable-mobile?-true
   ...
   :set-config-disable-webaudio?-true
   ...
   :set-config-disable-htmlaudio?-true
