...
(defba :bgm-option-e
  {:fn #(vnctst.audio4/bgm! "bgm/ny2017.*" :position 1.2 :oneshot? true)
   :cljs "(vnctst.audio4/bgm! \"bgm/ny2017.*\" :position 1.2 :oneshot? true)"
   :js "vnstst.audio4.js.bgm(\"bgm/ny2017.*\", {position: 1.2, \"oneshot?\": true})"
   })
