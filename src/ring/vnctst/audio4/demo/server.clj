                ...
                [:div
                 ...
                 [:ul
                  [:li
                   [:h4 "音が出ない"]
                   (p [:code "debug?"]
                      "フラグを有効にして、コンソールにエラー内容が出ていないか"
                      "確認してみよう")
                   (p "多くのブラウザでは、ローカルファイル("
                      [:code "file:///..."]
                      "形式のurl)からの再生はできません。"
                      "httpサーバを用意し、その中で動作確認しよう")]
                  [:li
                   [:h4 "音が小さい"]
                   (p "デフォルトの音量は25%相当です。"
                  ...
                  [:li
                   [:h4 "いちいち"
                        ...
                        "って書くのは長くて面倒"]
                   (p [:code "var va4 = vnctst.audio4.js;"]
                      "を実行しておけば、以降は"
                      [:code "va4.bgm(\"hoge.ogg\")"]
                      "ですみます")]
                  [:li
                   [:h4 "このオンラインデモのサンプルBGM/SEについて"]
                   (p "ayamadaが作成したものです。ライセンスはCC0とします")]
                  ]
                 ]
                ;; footer
                [:hr]
